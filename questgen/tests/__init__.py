...
from questgen.tests.knowledge_base_tests import *
from questgen.tests.machine_tests import *
from questgen.tests.facts_tests import *
...
from questgen.tests.quest_tests import *
